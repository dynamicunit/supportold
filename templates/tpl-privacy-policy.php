    ...
    <section class="container">
        <div class="row">
            <div class="col-lg-10 offset-lg-1">
                <p>
                    It is DynamicUnit's policy to respect your privacy regarding any
                    information we may collect while operating our website. This
                    Privacy Policy applies to <a href="https://dynamicunit.com">https://dynamicunit.com</a>
                    (hereinafter, "us", "we", or
                    "https://dynamicunit.com"). We respect your privacy and
                ...
                <p>This Privacy Policy, together with the Terms and conditions
                ...
                <p>Like most website operators, DynamicUnit collects
                    ...
                    of each visitor request. DynamicUnit's purpose in collecting
                    non-personally identifying information is to better understand how
                    DynamicUnit's visitors use its website. From time to time,
                    DynamicUnit may release non-personally-identifying information in
                    the aggregate, e.g., by publishing a report on trends in the usage
                    of its website.</p>

                <p>DynamicUnit also collects potentially personally-identifying
                    information like Internet Protocol (IP) addresses for logged in
                    users and for users leaving comments on https://dynamicunit.com
                    blog posts. DynamicUnit only discloses logged in user and
                ...
                <p>Certain visitors to DynamicUnit's websites choose to interact
                    with DynamicUnit in ways that require DynamicUnit to gather
                    personally-identifying information. The amount and type of
                    information that DynamicUnit gathers depends on the nature of the
                    interaction. For example, we ask visitors who sign up for a blog
                    at https://dynamicunit.com to provide a username and email
                    address.</p>
                ...
                <p>Ads appearing on our website may be delivered to users by
                    ...
                    covers the use of cookies by DynamicUnit and does not cover the
                ...
                <h3>https://dynamicunit.com uses Google AdWords for remarketing</h3>

                <p>https://dynamicunit.com uses the remarketing services to
                    ...
                    using the contact form to make an enquiry. This could be in the
                    form of an advertisement on the Google search results page, or a
                    ...
                    Of course, any data collected will be used in accordance with our
                    own privacy policy and Google's privacy policy.</p>

                <p>You can set preferences for how Google advertises to you using
                    the Google Ad Preferences page, and if you want to you can opt out
                    of interest-based advertising entirely by cookie settings or
                    permanently using a browser plugin.</p>

                <h3>Protection of Certain Personally-Identifying Information</h3>

                <p>DynamicUnit discloses potentially personally-identifying and
                    personally-identifying information only to those of its employees,
                    contractors and affiliated organizations that (i) need to know
                    that information in order to process it on DynamicUnit's behalf or
                    to provide services available at DynamicUnit's website, and (ii)
                    ...
                    outside of your home country; by using DynamicUnit's website, you
                    consent to the transfer of such information to them. DynamicUnit
                    ...
                    above, DynamicUnit discloses potentially personally-identifying
                    and personally-identifying information only in response to a
                    subpoena, court order or other governmental request, or when
                    DynamicUnit believes in good faith that disclosure is reasonably
                    necessary to protect the property or rights of DynamicUnit, third
                    parties or the public at large.</p>

                <p>If you are a registered user of https://dynamicunit.com and have
                    supplied your email address, DynamicUnit may occasionally send you
                    an email to tell you about new features, solicit your feedback, or
                    just keep you up to date with what's going on with DynamicUnit and
                    our products. We primarily use our blog to communicate this type
                    ...
                    or to help us support other users. DynamicUnit takes all measures
                ...
                <p>DynamicUnit may collect statistics about the behavior of
                    visitors to its website. DynamicUnit may display this information
                    publicly or provide it to others. However, DynamicUnit does not
                    disclose your personally-identifying information.</p>

                <h3>Affiliate Disclosure</h3>

                <p>This site uses affiliate links and does earn a commission from
                    certain links. This does not affect your purchases or the price
                    you may pay.</p>

                <h3>Cookies</h3>

                <p>To enrich and perfect your online experience, DynamicUnit uses
                ...
                <p>A cookie is a string of information that a website stores on a
                    visitor's computer, and that the visitor's browser provides to the
                    website each time the visitor returns. DynamicUnit uses cookies to
                    help DynamicUnit identify and track visitors, their usage of
                    https://dynamicunit.com, and their website access preferences.
                    DynamicUnit visitors who do not wish to have cookies placed on
                    their computers should set their browsers to refuse cookies before
                    using DynamicUnit's websites, with the drawback that certain
                    features of DynamicUnit's websites may not function properly
                    without the aid of cookies.</p>

                <p>By continuing to navigate our website without changing your
                    cookie settings, you hereby acknowledge and agree to DynamicUnit's
                    use of cookies.</p>

                <h3>Business Transfers</h3>

                <p>If DynamicUnit, or substantially all of its assets, were
                    acquired, or in the unlikely event that DynamicUnit goes out of
                    ...
                    of DynamicUnit may continue to use your personal information as
                    set forth in this policy.</p>

                <h3>Privacy Policy Changes</h3>

                <p>Although most changes are likely to be minor, DynamicUnit may
                    change its Privacy Policy from time to time, and in DynamicUnit's
                    sole discretion. DynamicUnit encourages visitors to frequently
                ...
                <p>
                    ...
                    contact us via out <a href="<?= $baseurl ?>/contact">contact</a>
                    page
                </p>
