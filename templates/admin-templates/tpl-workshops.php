...
<body>
            ...
            <div class="row">
                <div class="col">
                    <div class="d-flex align-items-center justify-content-between">
                        <h1>Workshops</h1>
                        <div>
                            <a href="<?= $baseurl ?>/admin/manage-workshop" class="btn btn-sm btn-outline-primary"><i
                                        ...
                                        <tr id="post_<?= $row['id'] ?>">
                                            ...
                                            <td>
                                                <a class="btn btn-sm btn-outline-primary"
                                                    href="<?= $baseurl ?>/admin/manage-workshop/<?= $row['id'] ?>"><i
                                                        class="fas fa-pencil"></i></a>
                                                <a href="#" class="btn btn-sm btn-outline-primary delete-workshop"
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="deleteEntityModalLabel">Delete Workshop</h5>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function () {
            ...
            document.querySelectorAll('.delete-workshop').forEach(function (button) {
            ...
            document.getElementById('confirmDeleteEntity').addEventListener('click', function () {
                ...
                fetch('<?= $baseurl ?>/admin/control/delete-workshop.php', {
                    method: 'POST',
                    body: formData
                })
                    .then(response => {
