...
try {
    ...
    $columns = 'a.ticket_id, a.issue_title, a.environment,a.issue_description,a.created_at, b.full_name user_name, c.description status';
    $table = 'tickets as a';
    $joins = [
        'JOIN users as b ON a.created_user_id = b.id',
        'JOIN lookups as c ON a.ticket_status = c.id'
    ];
    $conditions = [
        '1' => ['=', 1]
    ];
