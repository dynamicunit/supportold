            ...
            <div class="row">
                <div class="col">
                    <div class="d-flex align-items-center justify-content-between">
                        <h1>Website Entities</h1>
                        <div>
                            <a href="<?= $baseurl ?>/admin/manage-entity" class="btn btn-sm btn-outline-primary"><i
                                        ...
                                        <tr id="post_<?= $row['id'] ?>">
                                            ...
                                            <td>
                                                <a class="btn btn-sm btn-outline-primary"
                                                    href="<?= $baseurl ?>/admin/manage-entity/<?= $row['id'] ?>"><i
                                                        class="icon_pencil"></i></a>
                                                <a href="#" class="btn btn-sm btn-outline-primary delete-entity"
                                                    data-entity-id="<?= $row['id'] ?>"><i class="icon_trash"></i></a>
                                            </td>
                                        </tr>
                                    <?php endforeach;
                                } else {
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function () {
            ...
            document.getElementById('confirmDeleteEntity').addEventListener('click', function () {
                ...
                fetch('<?= $baseurl ?>/admin/control/delete-entity.php', {
                    method: 'POST',
                    body: formData
                })
                    .then(response => {
