    ...
    <script>
        document.addEventListener('DOMContentLoaded', () => {
            ...
            function addMessageToList(message, avatar_image) {
                ...
                messageDataDiv.className = `message-data d-flex gap-3 ${message.sender_id != loggeduser ? 'd-flex justify-content-end align-items-center gap-3' : ''}`;
                ...
                // Create dropdown for delete message
                ...
                dropdownToggle.href = '#';
                dropdownToggle.id = `dropdownMenuLink_${message.id}`;
                ...
                dropdownMenu.className = 'dropdown-menu dropdown-end';
                dropdownMenu.setAttribute('aria-labelledby', `dropdownMenuLink_${message.id}`);
                ...
                deleteLink.onclick = function () {
                    deleteMessage(message.id, listItem, message.sender_id, message.receiver_id);
                };
                ...
                messageDataDiv.appendChild(dropdownDiv);
            ...
            function deleteMessage(messageId, listItem, sender_id, receiver_id) {
                ...
                const url = '<?= $baseurl ?>/user/control/delete-message.php';
