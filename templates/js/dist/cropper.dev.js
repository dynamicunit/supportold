...
!function (t, e) {
  ...
  function P(t) {
    t = function (t, e) {
      ...
      if ("object" != _typeof(i = i.call(t, e || "default"))) return i;
  ...
  var kt,
      Ot,
      Tt = /\s\s*/,
      Et = (Ot = !1, t && (kt = !1, i = function i() {}, e = Object.defineProperty({}, "once", {
    get: function get() {
      return Ot = !0, kt;
    },
    set: function set(t) {
  ...
  function b(o, t, h, e) {
    ...
    t.trim().split(Tt).forEach(function (a) {
      var t, n;
      r.once && !Et && (t = o.listeners, _s = function s() {
  ...
  function Rt(t) {
    ...
    try {
      ...
      if (a = i && (n = i + 10, "Exif" === function (t, e, i) {
        ...
        return a;
      }(s, i + 4, 4)) && ((r = 18761 === (o = s.getUint16(n))) || 19789 === o) && 42 === s.getUint16(n + 2, r) && 8 <= (h = s.getUint32(n + 4, r)) ? n + h : a) for (var l, p = s.getUint16(a, r), m = 0; m < p; m += 1) {
