	...
	<section class="bg-primary text-light py-3">
		<div class="container">
			<div class="d-flex align-items-center fs-4">
				<i class="ft-file-text" class="text-primary"></i>
				<h1 class="fw-bold text-light h3 mb-0 mt-0 ms-2">Terms Of Services</h1>
			</div>
		...
		<div class="row">
			<div class="col-lg-10 offset-lg-1">
				<p>By accessing this website we assume you accept these terms and
					conditions. Do not continue to use DynamicUnit if you do not agree
				...
				<p>We employ the use of cookies. By accessing DynamicUnit, you
					agreed to use cookies in agreement with the DynamicUnit's Privacy
					Policy.</p>
				...
				<p>Unless otherwise stated, DynamicUnit and/or its licensors own
					the intellectual property rights for all material on DynamicUnit.
					All intellectual property rights are reserved. You may access this
					from DynamicUnit for your own personal use subjected to
					restrictions set in these terms and conditions.</p>

				<p>You must not:</p>

				<ul>
					<li>Republish material from DynamicUnit</li>
					<li>Sell, rent or sub-license material from DynamicUnit</li>
					<li>Reproduce, duplicate or copy material from DynamicUnit</li>
					<li>Redistribute content from DynamicUnit</li>
				</ul>
				...
				<p>Parts of this website offer an opportunity for users to post and
					...
					DynamicUnit does not filter, edit, publish or review Comments
					prior to their presence on the website. Comments do not reflect
					the views and opinions of DynamicUnit,its agents and/or
					...
					applicable laws, DynamicUnit shall not be liable for the Comments
				...
				<p>DynamicUnit reserves the right to monitor all Comments and to
				...
				<p>You hereby grant DynamicUnit a non-exclusive license to use,
				...
				<p>We will approve link requests from these organizations if we
					...
					DynamicUnit; and (d) the link is in the context of general
				...
				<p>If you are one of the organizations listed in paragraph 2 above
					...
					by sending an e-mail to DynamicUnit. Please include your name,
				...
				<p>No use of DynamicUnit's logo or other artwork will be allowed
